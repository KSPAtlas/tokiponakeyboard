...
public class MyKeyboardTelo extends MyKeyboardAbstract {
    ...
    public MyKeyboardTelo(Context context) {
        this(context, null, 0);
    }

    public MyKeyboardTelo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyKeyboardTelo(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.keyboard_telo, this, true);
    ...
    public void setColours() {
        ...
        findViewById(R.id.keyboard_telo).setBackgroundColor(backgroundColour);
    }
